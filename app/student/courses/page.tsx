...
const ENROLLED_COURSES = [
  ...
  },
  {
    id: 'ph-118',
    code: 'PH-118',
    name: 'Philosophy of Aarth',
    instructor: 'Dr. Marcus Aurel',
    progress: 0,
    color: '#c44545'
  }
];
...
export default function StudentCoursesPage() {
  ...
  const [selectedCourse, setSelectedCourse] = useState(ENROLLED_COURSES[0]);
  ...
  if (authLoading || loadingAssignments || loadingGrades) {
    return (
      <StudentLayout>
        ...
        <div className="w-80 bg-white rounded-2xl border border-[#e5e5e5] p-6 overflow-y-auto">
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <Badge className="bg-[#f2f0ed] text-[#666] text-[10px] font-bold border-0">FALL 2024</Badge>
            </div>
          </div>
            ...
            {ENROLLED_COURSES.map((course) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <RadialProgress progress={course.progress} color={course.color} />
                </div>
              </button>
            ))}
          </div>
            ...
            {activeTab === 'assignments' && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between">
                    <div>
                      <h2 className="text-2xl font-bold text-[#1a1a1a] mb-2">
                        Assignment 4: High-Fire Reduction
                      </h2>
                      <div className="flex items-center gap-4 text-sm">
                        <div className="flex items-center gap-2 text-[#c44545]">
                          <Clock className="w-4 h-4" />
                          <span className="font-medium">Due: Friday, 11:59 PM</span>
                        </div>
                        <div className="flex items-center gap-2 text-[#666]">
                          <Clock className="w-4 h-4" />
                          <span>Server Time: 09:42 PM</span>
                        </div>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="text-xs font-bold text-[#666] uppercase tracking-wider mb-1">
                        Weighting
                      </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border border-[#e5e5e5] rounded-xl overflow-hidden">
                      <button
                        onClick={() => setExpandedUnit(expandedUnit === 'unit-1' ? null : 'unit-1')}
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-medium text-[#1a1a1a]">Unit 1: Mineral Composition</span>
                        </div>
                    ...
                    {/* Unit 2 - Expanded */}
                    <div className="border-2 border-[#c44545] rounded-xl overflow-hidden">
                      <button
                        onClick={() => setExpandedUnit(expandedUnit === 'unit-2' ? null : 'unit-2')}
                        className="w-full flex items-center justify-between p-4 bg-[#c44545]/5"
                      >
                        <div className="flex items-center gap-3">
                          <ChevronDown className="w-5 h-5 text-[#c44545]" />
                          <span className="font-medium text-[#1a1a1a]">Unit 2: Reduction Dynamics</span>
                        </div>
                      ...
                      {expandedUnit === 'unit-2' && (
                        <div className="p-4 border-t border-[#c44545]/20 bg-white">
                          <p className="text-sm text-[#666] leading-relaxed">
                            Research the effects of limited oxygen flow in gas kilns on iron oxide glazes.
                            Focus on the transformation of Red Iron Oxide to Black Iron Oxide at
                ...
                <div className="border border-[#e5e5e5] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#1a1a1a] mb-4">Submission Portal</h3>
                  
                  <div className="border-2 border-dashed border-[#e5e5e5] rounded-xl p-12 text-center mb-6">
                    <div className="w-16 h-16 bg-[#c44545]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                      <FileText className="w-8 h-8 text-[#c44545]" />
                    </div>
                    <h4 className="text-lg font-bold text-[#1a1a1a] mb-2">
                      Drag & drop your research paper
                    </h4>
                    <p className="text-sm text-[#666] mb-4">
                      Supports PDF, ZIP, or GitHub Repository Link
                    </p>
                    <Button className="bg-[#c44545] hover:bg-[#c44545]/90 text-white rounded-lg">
                      Select Files
                    </Button>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-4 bg-[#f2f0ed] rounded-lg">
                        <div className="flex items-center gap-4">
                          <div className="text-sm">
                            <p className="font-bold text-[#1a1a1a] mb-1">CER-402-V1</p>
                            <p className="text-xs text-[#666]">Oct 12, 14:32</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center justify-between p-4 bg-[#f2f0ed] rounded-lg">
                        <div className="flex items-center gap-4">
                          <div className="text-sm">
                            <p className="font-bold text-[#1a1a1a] mb-1">CER-402-D3</p>
                            <p className="text-xs text-[#666]">Oct 10, 09:15</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-amber-500 rounded-full"></div>
                            <span className="text-sm font-medium text-amber-600">Superseded</span>
                          </div>
